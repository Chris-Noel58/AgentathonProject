...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      <form onSubmit={handleLogin} className="p-8 bg-white border border-gray-200 rounded-xl shadow-lg w-full max-w-sm">
        ...
        <button type="submit" className="w-full bg-[#006633] text-white p-2 rounded">Login</button>
      </form>
    </div>
  );
}
